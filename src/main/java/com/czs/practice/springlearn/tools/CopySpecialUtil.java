...
public class CopySpecialUtil {
    ...
    public static void main(String[] args) {
        ...
        one.setDriver_mobile("11111111111");
        ...
        two.setDriverMobile("22222222222");
...
//            copy(one,two);
//            System.out.println(two);
            System.out.println(copy(one,TestTwo.class));
    ...
    public static void copy(Object source, Object target) throws Exception{
        ...
        for(Field sourceField : sourceFields){
            ...
            out:for(Field targetField : targetFields){
                ...
                String nameUnderline = ConvertCamel.underline(new StringBuffer(targetField.getName())).toString();
                String nameCamel = ConvertCamel.camel(new StringBuffer(targetField.getName())).toString();
                if(name.equals(nameUnderline) || name.equals(nameCamel) ){
